...
"}")
        ...
        self.gridLayout_6.addWidget(self.LineEdit_stuff_y2, 8, 3, 1, 1)
...
from qfluentwidgets import BodyLabel, CheckBox, ComboBox, LineEdit, PopUpAniStackedWidget, PushButton, ScrollArea, \
    SimpleCardWidget, StrongBodyLabel, TitleLabel, ToolButton
