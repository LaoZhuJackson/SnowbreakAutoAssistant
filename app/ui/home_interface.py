...
class Ui_home(object):
    def setupUi(self, home):
        ...
        self.ToolButton_collect = ToolButton(self.SimpleCardWidget_option)
        self.ToolButton_collect.setEnabled(True)
        self.ToolButton_collect.setObjectName("ToolButton_collect")
        self.gridLayout_7.addWidget(self.ToolButton_collect, 3, 4, 1, 1)
        ...
        self.ToolButton_reward.setEnabled(False)
        ...
        self.gridLayout_12.addWidget(self.PushButton_select_directory, 2, 2, 1, 1)
        self.StrongBodyLabel_4 = StrongBodyLabel(self.page_5)
        self.StrongBodyLabel_4.setObjectName("StrongBodyLabel_4")
        self.gridLayout_12.addWidget(self.StrongBodyLabel_4, 0, 0, 1, 3)
        self.StrongBodyLabel_6 = StrongBodyLabel(self.page_5)
        self.StrongBodyLabel_6.setObjectName("StrongBodyLabel_6")
        self.gridLayout_12.addWidget(self.StrongBodyLabel_6, 3, 0, 1, 3)
        ...
        self.gridLayout_12.addWidget(self.BodyLabel_enter_tip, 6, 0, 1, 3)
        ...
        self.gridLayout_12.addWidget(self.CheckBox_auto_open_starter, 2, 0, 1, 2)
        ...
        self.gridLayout_12.addWidget(self.LineEdit_starter_directory, 1, 0, 1, 3)
        self.LineEdit_link = LineEdit(self.page_5)
        self.LineEdit_link.setEnabled(True)
        self.LineEdit_link.setObjectName("LineEdit_link")
        self.gridLayout_12.addWidget(self.LineEdit_link, 4, 0, 1, 3)
        ...
        self.CheckBox_dormitory = CheckBox(self.page_3)
        self.CheckBox_dormitory.setObjectName("CheckBox_dormitory")
        self.gridLayout_10.addWidget(self.CheckBox_dormitory, 2, 0, 1, 1)
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.CheckBox_buy_12.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.CheckBox_buy_9.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.CheckBox_buy_10.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.CheckBox_buy_15.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.CheckBox_buy_11.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.CheckBox_buy_5.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.CheckBox_buy_3.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.CheckBox_buy_13.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.CheckBox_buy_4.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.CheckBox_buy_6.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.CheckBox_buy_7.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.CheckBox_buy_8.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.CheckBox_buy_14.sizePolicy().hasHeightForWidth()
        )
        ...
        self.PushButton_update_stuff = PushButton(self.page_2)
        self.PushButton_update_stuff.setObjectName("PushButton_update_stuff")
        self.gridLayout_6.addWidget(self.PushButton_update_stuff, 14, 0, 1, 2)
        self.LineEdit_chasm_y2 = LineEdit(self.page_2)
        self.LineEdit_chasm_y2.setObjectName("LineEdit_chasm_y2")
        self.gridLayout_6.addWidget(self.LineEdit_chasm_y2, 13, 3, 1, 1)
        self.BodyLabel_12 = BodyLabel(self.page_2)
        self.BodyLabel_12.setObjectName("BodyLabel_12")
        self.gridLayout_6.addWidget(self.BodyLabel_12, 9, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.ComboBox_power_usage, 2, 0, 1, 4)
        self.BodyLabel_11 = BodyLabel(self.page_2)
        self.BodyLabel_11.setObjectName("BodyLabel_11")
        self.gridLayout_6.addWidget(self.BodyLabel_11, 9, 0, 1, 1)
        self.BodyLabel_18 = BodyLabel(self.page_2)
        self.BodyLabel_18.setObjectName("BodyLabel_18")
        self.gridLayout_6.addWidget(self.BodyLabel_18, 13, 2, 1, 1)
        self.BodyLabel_17 = BodyLabel(self.page_2)
        self.BodyLabel_17.setObjectName("BodyLabel_17")
        self.gridLayout_6.addWidget(self.BodyLabel_17, 13, 0, 1, 1)
        self.PushButton_update_chasm = PushButton(self.page_2)
        self.PushButton_update_chasm.setObjectName("PushButton_update_chasm")
        self.gridLayout_6.addWidget(self.PushButton_update_chasm, 14, 2, 1, 2)
        self.LineEdit_stuff_y1 = LineEdit(self.page_2)
        self.LineEdit_stuff_y1.setObjectName("LineEdit_stuff_y1")
        self.gridLayout_6.addWidget(self.LineEdit_stuff_y1, 6, 3, 1, 1)
        self.StrongBodyLabel_2 = StrongBodyLabel(self.page_2)
        self.StrongBodyLabel_2.setObjectName("StrongBodyLabel_2")
        self.gridLayout_6.addWidget(self.StrongBodyLabel_2, 1, 0, 1, 4)
        self.LineEdit_stuff_x1 = LineEdit(self.page_2)
        self.LineEdit_stuff_x1.setObjectName("LineEdit_stuff_x1")
        self.gridLayout_6.addWidget(self.LineEdit_stuff_x1, 6, 1, 1, 1)
        self.LineEdit_stuff_x2 = LineEdit(self.page_2)
        self.LineEdit_stuff_x2.setObjectName("LineEdit_stuff_x2")
        self.gridLayout_6.addWidget(self.LineEdit_stuff_x2, 9, 1, 1, 1)
        self.BodyLabel_15 = BodyLabel(self.page_2)
        self.BodyLabel_15.setObjectName("BodyLabel_15")
        self.gridLayout_6.addWidget(self.BodyLabel_15, 11, 2, 1, 1)
        self.LineEdit_chasm_x2 = LineEdit(self.page_2)
        self.LineEdit_chasm_x2.setObjectName("LineEdit_chasm_x2")
        self.gridLayout_6.addWidget(self.LineEdit_chasm_x2, 13, 1, 1, 1)
        self.BodyLabel_16 = BodyLabel(self.page_2)
        self.BodyLabel_16.setObjectName("BodyLabel_16")
        self.gridLayout_6.addWidget(self.BodyLabel_16, 12, 0, 1, 4)
        self.LineEdit_chasm_x1 = LineEdit(self.page_2)
        self.LineEdit_chasm_x1.setObjectName("LineEdit_chasm_x1")
        self.gridLayout_6.addWidget(self.LineEdit_chasm_x1, 11, 1, 1, 1)
        self.BodyLabel_10 = BodyLabel(self.page_2)
        self.BodyLabel_10.setObjectName("BodyLabel_10")
        self.gridLayout_6.addWidget(self.BodyLabel_10, 8, 0, 1, 4)
        self.BodyLabel_13 = BodyLabel(self.page_2)
        self.BodyLabel_13.setObjectName("BodyLabel_13")
        self.gridLayout_6.addWidget(self.BodyLabel_13, 10, 0, 1, 4)
        self.BodyLabel_7 = BodyLabel(self.page_2)
        self.BodyLabel_7.setObjectName("BodyLabel_7")
        self.gridLayout_6.addWidget(self.BodyLabel_7, 6, 0, 1, 1)
        ...
        self.LineEdit_stuff_y2 = LineEdit(self.page_2)
        self.LineEdit_stuff_y2.setObjectName("LineEdit_stuff_y2")
        self.gridLayout_6.addWidget(self.LineEdit_stuff_y2, 9, 3, 1, 1)
        self.BodyLabel_9 = BodyLabel(self.page_2)
        self.BodyLabel_9.setObjectName("BodyLabel_9")
        self.gridLayout_6.addWidget(self.BodyLabel_9, 6, 2, 1, 1)
        self.BodyLabel_2 = BodyLabel(self.page_2)
        self.BodyLabel_2.setObjectName("BodyLabel_2")
        self.gridLayout_6.addWidget(self.BodyLabel_2, 5, 0, 1, 4)
        self.BodyLabel_14 = BodyLabel(self.page_2)
        self.BodyLabel_14.setObjectName("BodyLabel_14")
        self.gridLayout_6.addWidget(self.BodyLabel_14, 11, 0, 1, 1)
        self.LineEdit_chasm_y1 = LineEdit(self.page_2)
        self.LineEdit_chasm_y1.setObjectName("LineEdit_chasm_y1")
        self.gridLayout_6.addWidget(self.LineEdit_chasm_y1, 11, 3, 1, 1)
        self.LineEdit_task_name = LineEdit(self.page_2)
        self.LineEdit_task_name.setObjectName("LineEdit_task_name")
        self.gridLayout_6.addWidget(self.LineEdit_task_name, 4, 2, 1, 2)
        self.BodyLabel_19 = BodyLabel(self.page_2)
        self.BodyLabel_19.setObjectName("BodyLabel_19")
        self.gridLayout_6.addWidget(self.BodyLabel_19, 4, 0, 1, 2)
        self.StrongBodyLabel_5 = StrongBodyLabel(self.page_2)
        self.StrongBodyLabel_5.setObjectName("StrongBodyLabel_5")
        self.gridLayout_6.addWidget(self.StrongBodyLabel_5, 3, 0, 1, 2)
        self.PrimaryPushButton_tutor = PrimaryPushButton(self.page_2)
        self.PrimaryPushButton_tutor.setObjectName("PrimaryPushButton_tutor")
        self.gridLayout_6.addWidget(self.PrimaryPushButton_tutor, 3, 2, 1, 2)
        ...
        self.LineEdit_c4 = LineEdit(self.page_4)
        self.LineEdit_c4.setObjectName("LineEdit_c4")
        self.horizontalLayout_5.addWidget(self.LineEdit_c4)
        self.horizontalLayout_5.setStretch(0, 1)
        self.horizontalLayout_5.setStretch(1, 2)
        self.gridLayout_11.addLayout(self.horizontalLayout_5, 4, 0, 1, 1)
        self.BodyLabel_person_tip = BodyLabel(self.page_4)
        self.BodyLabel_person_tip.setTextFormat(QtCore.Qt.MarkdownText)
        self.BodyLabel_person_tip.setWordWrap(True)
        self.BodyLabel_person_tip.setObjectName("BodyLabel_person_tip")
        self.gridLayout_11.addWidget(self.BodyLabel_person_tip, 7, 0, 1, 1)
        ...
        self.LineEdit_c3 = LineEdit(self.page_4)
        self.LineEdit_c3.setObjectName("LineEdit_c3")
        self.horizontalLayout_4.addWidget(self.LineEdit_c3)
        ...
        self.LineEdit_c1 = LineEdit(self.page_4)
        self.LineEdit_c1.setObjectName("LineEdit_c1")
        self.horizontalLayout_2.addWidget(self.LineEdit_c1)
        ...
        self.LineEdit_c2 = LineEdit(self.page_4)
        self.LineEdit_c2.setObjectName("LineEdit_c2")
        self.horizontalLayout_3.addWidget(self.LineEdit_c2)
        ...
        self.gridLayout_11.addItem(spacerItem7, 8, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents_tips = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_tips.setGeometry(QtCore.QRect(0, 0, 332, 190))
        self.scrollAreaWidgetContents_tips.setObjectName(
            "scrollAreaWidgetContents_tips"
        )
        self.gridLayout_tips = QtWidgets.QGridLayout(self.scrollAreaWidgetContents_tips)
        ...
        self.gridLayout_9.addWidget(self.ScrollArea_tips, 1, 0, 1, 1)
    ...
    def retranslateUi(self, home):
        ...
        self.CheckBox_stamina_2.setText(_translate("home", "领取物资"))
        ...
        self.StrongBodyLabel_6.setText(_translate("home", "活动公告链接"))
        ...
        self.CheckBox_dormitory.setText(_translate("home", "宿舍碎片"))
        ...
        self.PushButton_update_stuff.setText(_translate("home", "更新“材料”"))
        self.BodyLabel_12.setText(_translate("home", "y2:"))
        self.BodyLabel_11.setText(_translate("home", "x2:"))
        self.BodyLabel_18.setText(_translate("home", "y2:"))
        self.BodyLabel_17.setText(_translate("home", "x2:"))
        self.PushButton_update_chasm.setText(_translate("home", "更新“深渊”"))
        self.StrongBodyLabel_2.setText(_translate("home", "选择体力使用方式"))
        self.BodyLabel_15.setText(_translate("home", "y1:"))
        self.BodyLabel_16.setText(_translate("home", '"深渊"右下角坐标'))
        self.BodyLabel_10.setText(_translate("home", '"材料"右下角坐标'))
        self.BodyLabel_13.setText(_translate("home", '"深渊"左上角坐标'))
        self.BodyLabel_7.setText(_translate("home", "x1:"))
        self.CheckBox_is_use_power.setText(_translate("home", "自动使用期限"))
        self.ComboBox_power_day.setProperty(
            "items_", _translate("home", "1\n2\n3\n4\n5\n6")
        )
        self.BodyLabel_6.setText(_translate("home", "天内的体力药"))
        self.BodyLabel_9.setText(_translate("home", "y1:"))
        self.BodyLabel_2.setText(_translate("home", '"材料"左上角坐标'))
        self.BodyLabel_14.setText(_translate("home", "x1:"))
        self.BodyLabel_19.setText(_translate("home", "新版任务名字："))
        self.StrongBodyLabel_5.setText(_translate("home", "适配新版本"))
        self.PrimaryPushButton_tutor.setText(_translate("home", "适配教程"))
        self.BodyLabel_8.setText(_translate("home", "角色4："))
        self.BodyLabel_person_tip.setText(_translate("home", "Body label"))
