...
class Ui_additional_features(object):
    def setupUi(self, additional_features):
        ...
        additional_features.resize(688, 620)
        ...
        self.gridLayout_5.addWidget(self.BodyLabel_tip_fish, 10, 0, 1, 3)
...
from qfluentwidgets import BodyLabel, CheckBox, LineEdit, PixmapLabel, PrimaryPushButton, PushButton, SegmentedWidget, \
    SimpleCardWidget, SpinBox, StrongBodyLabel, TitleLabel
