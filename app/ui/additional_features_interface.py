...
"border: 2px;")
        ...
        self.PushButton_start_action = PushButton(self.page_2)
        ...
        self.SimpleCardWidget_action = SimpleCardWidget(self.page_2)
        ...
        self.BodyLabel_2 = BodyLabel(self.SimpleCardWidget_action)
...
"* 当一个钓鱼点钓完后需要手动移动到下一个钓鱼点，进入钓鱼界面后再启动一次"))
        ...
        self.BodyLabel_2.setText(_translate("additional_features", "### 提示\n"
                                                                   "自动完成常规行动\n"
                                                                   "* 不消耗体力\n"
                                                                   "* 重复刷指定次数实战训练第一关\n"
                                                                   ""))
