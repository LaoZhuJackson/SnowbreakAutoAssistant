...
class Ui_additional_features(object):
    def setupUi(self, additional_features):
        ...
        self.textBrowser_log_drink = QtWidgets.QTextBrowser(self.SimpleCardWidget_8)
        self.textBrowser_log_drink.setStyleSheet("")
        self.textBrowser_log_drink.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.textBrowser_log_drink.setObjectName("textBrowser_log_drink")
        self.gridLayout_24.addWidget(self.textBrowser_log_drink, 1, 0, 1, 1)
