...
class Ui_additional_features(object):
    def setupUi(self, additional_features):
        ...
        self.gridLayout_5.addWidget(self.CheckBox_is_save_fish, 0, 0, 1, 3)
        ...
        self.textBrowser_log_fishing = QtWidgets.QTextBrowser(self.page_fishing)
        self.textBrowser_log_fishing.setStyleSheet("border-radius: 5px;\n"
"border: 2px;")
        ...
        self.gridLayout_2.addWidget(self.textBrowser_log_fishing, 0, 1, 2, 1)
        ...
        self.PushButton = PushButton(self.page_2)
        self.PushButton.setObjectName("PushButton")
        self.gridLayout_3.addWidget(self.PushButton, 2, 0, 1, 1)
        self.textBrowser_log_action = QtWidgets.QTextBrowser(self.page_2)
        self.textBrowser_log_action.setStyleSheet("border-radius: 5px;\n"
                                                  "border: 2px;")
        ...
        self.gridLayout_3.addWidget(self.textBrowser_log_action, 1, 1, 2, 1)
        ...
        self.SpinBox_action_times = SpinBox(self.SimpleCardWidget)
        ...
        self.BodyLabel_2.setTextFormat(QtCore.Qt.MarkdownText)
        self.BodyLabel_2.setObjectName("BodyLabel_2")
        self.gridLayout_6.addWidget(self.BodyLabel_2, 1, 0, 1, 2)
        self.gridLayout_3.addWidget(self.SimpleCardWidget, 1, 0, 1, 1)
...
"* 当一个钓鱼点钓完后需要手动移动到下一个钓鱼点，进入钓鱼界面后再启动一次"))
        ...
        self.PushButton.setText(_translate("additional_features", "开始行动"))
        self.BodyLabel_4.setText(_translate("additional_features", "刷取次数"))
        self.BodyLabel_2.setText(_translate("additional_features", "# 提醒\n"
                                                                   "自动完成常规行动\n"
                                                                   "* 不消耗体力\n"
                                                                   "* 重复刷指定次数教学第一关"))
