...
class Ui_additional_features(object):
    def setupUi(self, additional_features):
        ...
        self.ComboBox_mode_maze_2 = ComboBox(self.SimpleCardWidget_massaging)
        self.ComboBox_mode_maze_2.setObjectName("ComboBox_mode_maze_2")
        self.gridLayout_20.addWidget(self.ComboBox_mode_maze_2, 0, 1, 1, 1)
    ...
    def retranslateUi(self, additional_features):
        ...
        self.BodyLabel_30.setText(_translate("additional_features", "运行模式"))
