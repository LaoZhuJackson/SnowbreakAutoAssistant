    ...
    def receive_work(self):
        ...
        while True:
            ...
            if self.auto.find_element(
                ["定期", "周常"],
                "text",
                crop=(988 / 1920, 238 / 1080, 1083 / 1920, 288 / 1080),
                is_log=self.is_log,
            ) and not self.auto.click_element(
                "键领取",
                "text",
                crop=(24 / 1920, 959 / 1080, 231 / 1920, 1032 / 1080),
                is_log=self.is_log,
            ):
                break
            ...
            if self.auto.find_element(
                "目标达成",
                "text",
                crop=(1248 / 2560, 602 / 1440, 1595 / 2560, 724 / 1440),
                is_log=self.is_log,
            ):
                first_finish_flag = True
            if self.auto.click_element(
            ...
            if self.auto.click_element(
                "查看详情",
                "text",
                crop=(839 / 1920, 222 / 1080, 1049 / 1920, 290 / 1080),
                is_log=self.is_log,
            ):
                execution_flag = True
            ...
            if first_finish_flag:
                self.auto.click_element(
                    "定期",
                    "text",
                    crop=(0, 225 / 1080, 128 / 1920, 282 / 1080),
                    is_log=self.is_log,
                )
                time.sleep(0.5)
                continue
            if self.auto.click_element(
                ...
                if not execution_flag:
                    ...
                    first_finish_flag = True
            if self.auto.click_element(
                "等级提升", "text", crop=(824 / 1920, 0, 1089 / 1920, 129 / 1080)
            ):
                self.auto.press_key("esc")
                continue
        ...
        while True:
            ...
            if not enter_flag:
                self.auto.click_element(
                    "凭证",
                    "text",
                    crop=(280 / 1920, 541 / 1080, 389 / 1920, 607 / 1080),
                    is_log=self.is_log,
                )
                time.sleep(0.5)
                ...
                if not first_finish_flag:
                    ...
                    if self.auto.click_element(
                        "奖励",
                        "text",
                        crop=(912 / 1920, 994 / 1080, 1067 / 1920, 1),
                        is_log=self.is_log,
                    ):
                        continue
