        ...
        while True:
            ...
            if enter_power_select:
                ...
                if confirm_flag:
                    if self.auto.click_element(
                        "确定",
                        "text",
                        crop=(1259 / 1920, 808 / 1080, 1422 / 1920, 864 / 1080),
                    ):
                        time.sleep(0.2)
                        continue
            ...
            if not confirm_flag and not enter_power_select:
                ...
                self.auto.click_element_with_pos(
                    pos=(int(880 / self.auto.scale_x), int(32 / self.auto.scale_y))
                )
                time.sleep(0.5)
                continue
            if timeout.reached():
        ...
        while True:
            ...
            if not enter_maneuver_flag:
                ...
                if self.auto.find_element(
                    "解锁",
                    "text",
                    crop=(717 / 1920, 441 / 1080, 1211 / 1920, 621 / 1080),
                    is_log=self.is_log,
                ):
                    finish_flag = True
                ...
                if self.auto.click_element(
                    "速战",
                    "text",
                    crop=(1368 / 1920, 963 / 1080, 1592 / 1920, 1),
                    is_log=self.is_log,
                ):
                    time.sleep(0.7)
                    enter_maneuver_flag = True
                    continue
                if self.auto.click_element(
                    "材料", "text", crop=stuff_pos, n=50, is_log=self.is_log
                ) or self.auto.click_element(
                    "app/resource/images/use_power/stuff.png",
                    "image",
                    crop=stuff_pos,
                    is_log=self.is_log,
                ):
                    ...
                    if not (
                        ...
                        time.sleep(0.3)
                if self.auto.click_element(
                    "深渊", "text", crop=chasm_pos, is_log=self.is_log
                ) or self.auto.click_element(
                    "app/resource/images/use_power/chasm.png",
                    "image",
                    crop=chasm_pos,
                    is_log=self.is_log,
                ):
                ...
                if self.auto.click_element(
                    "任务",
                    "text",
                    crop=(1445 / 1920, 321 / 1080, 1552 / 1920, 398 / 1080),
                ...
                if finish_flag:
                    if self.auto.find_element(
                        ...
                        is_log=self.is_log,
                    ) or self.auto.find_element(
                        "领取",
                        "text",
                        crop=(0, 937 / 1080, 266 / 1920, 1),
                        is_log=self.is_log,
                    ):
                        enter_task = True
                    if enter_task:
                        ...
                        if not self.auto.find_element(
                            ...
                            break
                    if self.auto.click_element(
                        "任务", "text", crop=(0, 1280 / 1440, 1, 1), is_log=self.is_log
                    ):
                        time.sleep(0.2)
                        continue
                    else:
                    ...
                    if self.auto.click_element(
                        "最大",
                        "text",
                        crop=(1221 / 1920, 679 / 1080, 1354 / 1920, 756 / 1080),
                        is_log=self.is_log,
                    ):
                        pass
                    if self.auto.click_element(
