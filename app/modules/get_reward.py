...
from app.common.operation import move_to_then_click, match_all_by_x, is_exist_image, back_to_home, wait_then_click


class get_reward_module:
    def __init__(self):
        self.reward_root = "app/resource/images/reward/"
