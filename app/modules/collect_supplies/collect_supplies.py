...
class CollectSuppliesModule:
    ...
    def friends_power(self):
        ...
        while True:
            ...
            if self.auto.find_element(
                "感知",
                "text",
                crop=(761 / 1920, 517 / 1080, 1175 / 1920, 563 / 1080),
                is_log=self.is_log,
            ):
                break
            # 重复进入的情况
        ...
        while True:
            ...
            if confirm_flag:
                if self.auto.click_element(
                    "购买",
                    "text",
                    crop=(1271 / 1920, 747 / 1080, 1353 / 1920, 795 / 1080),
                    is_log=self.is_log,
                ):
                    break
            # 已经领取但重复进入的情况
            if self.auto.find_element(
                ...
                if self.auto.find_element(
                    ...
                    "image",
                    crop=(0, 397 / 1080, 91 / 1920, 486 / 1080),
                    is_log=self.is_log,
                ):
                    if not self.auto.find_element(
                        "每日物资配给箱",
            ...
            if self.auto.click_element(
                "供应站",
                "text",
                crop=(141 / 1920, 553 / 1080, 229 / 1920, 596 / 1080),
                is_log=self.is_log,
            ):
                continue
            if timeout.reached():
    ...
    def receive_mail(self):
        ...
        while True:
            ...
            if self.auto.click_element(
                "批量领取",
                "text",
                crop=(303 / 1920, 982 / 1080, 462 / 1920, 1028 / 1080),
                is_log=self.is_log,
            ):
                click_flag = True
                continue
    ...
    def receive_fish_bait(self):
        ...
        while True:
            ...
            if self.auto.find_element(
                "开拓任务",
                "text",
                crop=(36 / 1920, 103 / 1080, 163 / 1920, 155 / 1080),
                is_log=self.is_log,
            ):
                if not self.auto.click_element(
                    "键领取",
                    "text",
                    crop=(22 / 1920, 965 / 1080, 227 / 1920, 1030 / 1080),
                    is_log=self.is_log,
            ...
            if self.auto.click_element(
                "开拓目标",
                "text",
                crop=(1611 / 1920, 879 / 1080, 1716 / 1920, 919 / 1080),
                is_log=self.is_log,
            ):
                time.sleep(0.5)
                continue
    ...
    def receive_dormitory(self):
        ...
        while True:
            ...
            if finish_flag and self.auto.click_element(
                "退出",
                "text",
            ...
            if self.auto.click_element(
                "谢谢",
                "text",
                crop=(1138 / 2560, 1075 / 1440, 1418 / 2560, 1153 / 1440),
                is_log=self.is_log,
            ):
                time.sleep(0.3)
                finish_flag = True
            ...
            if self.auto.click_element(
                "键收取",
                "text",
                crop=(1845 / 2560, 983 / 1440, 2073 / 2560, 1061 / 1440),
                is_log=self.is_log,
            ):
                time.sleep(1.5)
                self.auto.take_screenshot()
            ...
            if self.auto.click_element(
                "基地",
                "text",
                crop=(2130 / 2560, 913 / 1440, 2217 / 2560, 977 / 1440),
                is_log=self.is_log,
            ):
                time.sleep(3)
                continue
            if self.auto.find_element(
                "Esc",
                "text",
                crop=(57 / 2560, 117 / 1440, 127 / 2560, 157 / 1440),
                is_log=self.is_log,
            ):
                self.auto.press_key("esc")
                continue
